...
Quando o `/diagnostico-comercial` sugerir entregáveis modulares, apresentar como recomendação com o porquê (baseado no que a call mostrou), não como decisão fechada.
