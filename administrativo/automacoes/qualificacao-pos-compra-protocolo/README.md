...
Formulário na página de qualificação (`conteudo/landing-maxxima-low-ticket/qualificacao.html`), que
grava tudo numa linha só do Google Sheets e avisa o grupo do WhatsApp. Depois de responder, a pessoa
é redirecionada pra `conteudo/landing-maxxima-low-ticket/obrigado.html`, a página final de confirmação.

Fluxo completo: Hotmart → `/qualificacao` (formulário) → `/obrigado` (confirmação, "fica de olho no seu e-mail").

O formulário pede nome, telefone, e-mail, se possui loja de carros e o Instagram da loja — tudo numa
linha só, sem precisar cruzar dados de fontes diferentes.
