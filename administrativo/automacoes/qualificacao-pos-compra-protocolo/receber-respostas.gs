/**
 * Recebe as respostas do formulário de qualificação da página de obrigado
 * do Protocolo Visita Garantida (obrigado.html) e grava uma linha na planilha.
 *
 * Como publicar:
 ...
 *      Data/Hora | Possui loja de carros? | Instagram da loja | Página
 ...
 *      dentro de obrigado.html (procure "COLE_AQUI_A_URL_DO_APPS_SCRIPT").
